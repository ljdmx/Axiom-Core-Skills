...
```json
{
  ...
  "shared_architectural_patterns": {
    "conflict_resolution": {
      "strategy": "Hierarchy-First",
      "tiebreaker": "Matrix-Lookup",
      "logic": "If Layer(Contested) in Matrix(Ownership) -> Apply Owner; Else -> Apply SKILL_PRIORITY Hierarchy"
    },
    "naming_conventions": {
      "api": "RESTful / RFC 7807",
      "frontend": "Atomic Design / OKLCH",
      "web3": "EIP-compliant / Visual Delta"
    }
  }
}
```
