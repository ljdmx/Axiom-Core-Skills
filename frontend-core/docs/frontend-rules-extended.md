...
> **Usage**: `view_file(docs/frontend-rules-extended.md)`
...
|---|---|---|
| v1.0 | 2026-03-09 | Extracted from DDFM SKILL.md §14–§18 + enhanced §17 with 3 additional rules and §18 with canonical URLs + CWV gate |
