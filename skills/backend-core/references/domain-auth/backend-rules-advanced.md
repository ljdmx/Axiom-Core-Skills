...
> - §19–—0 → consumer/B2C apps with strong privacy requirements
...
- **Audit Trail Exception**: Audit logs and financial transaction records have separate legal retention requirements (typically 5— years). These MUST be exempted from TTL-based deletion and documented in the Data Retention Policy.
...
|---|---|---|
| v1.0 | 2026-03-09 | Extracted from ADBM SKILL.md §11, §12, §14, §15, §19–—0. Enhanced each section with additional rules: mutation testing, GraphQL schema governance, DLQ dashboard mandate, LLM cost observability + fallback chain, CRDT conflict resolution, GDPR erasure propagation |
