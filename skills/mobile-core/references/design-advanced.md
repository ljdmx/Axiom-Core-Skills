# DDFM Advanced Design System: Material 路 Responsive 路 Performance 路 A11y
...
| Part-to-Whole (鈮?) | Donut | 3D Pie Chart |
...
### 2.1 Multi-Dimensional Materials (C-Level Extraordinary Experience 路 Pure CSS)
...
- **Macro Structural Migration (Master-Detail)**: Mobile's "List 鈫?Detail page" transition morphs into Wide-screen "Left 35% List + Right 65% Detail" Master-Detail layout.
...
- **Minimum Touch Hotspot**: The physical tap zone for all clickable elements MUST be **鈮?44脳44pt** (Translated to uni-app as `88rpx 脳 88rpx` minimums).
