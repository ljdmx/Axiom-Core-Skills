...
> **Status**: ACTIVE â€?Run before every component handoff.
> **Standard**: WCAG 2.1 Level AA (Level AAA for Compliance-grade UIs per Â§0).
...
### Color & Contrast
- [ ] Normal text (< 18px): contrast ratio â‰?**4.5:1** against background
- [ ] Large text (â‰?18px or 14px bold): contrast ratio â‰?**3:1**
- [ ] UI components (borders, icons, focus rings): contrast â‰?**3:1**
...
- [ ] `--semantic-*` tokens validated in both light AND dark mode (DDFM Â§28)
...
- [ ] Base font size â‰?16px (allows browser zoom without breaking layout)
...
- [ ] Time-limited sessions warn user â‰?20 seconds before expiry with option to extend
...
- [ ] Page `<title>` is unique and descriptive (DDFM Â§18)
- [ ] Heading hierarchy: single `<h1>` per page, logical H1â†’H2â†’H3 flow, no skipped levels
...
|---|---|---|
| v1.0 | 2026-03-09 | Initial creation â€?WCAG 2.1 AA complete checklist aligned with DDFM Â§5, Â§8, Â§10, Â§11, Â§17 rules |
