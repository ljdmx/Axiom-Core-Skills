...
// Luxury product: 35—5°   (compressed compression = premium feel)
// Architecture: 25—5°     (tall spaces feel even taller)
// Game / exploration: 60—5°
// Epic landscape: 20—0°
// Intimate portrait: 45—5°
```
...
loadingManager.onLoad = () => {
  ...
  // Stage 2: Subject enters (400ms—200ms)
  ...
  // Stage 3: Camera approaches (600ms—100ms)
