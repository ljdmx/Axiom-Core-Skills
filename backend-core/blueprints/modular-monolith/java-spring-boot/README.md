...
This blueprint uses **Spring Data JPA** by default. For teams preferring SQL-first development, see the **[MyBatis Plus Guide](../../references/databases/mybatis-plus-guide.md)** for a complete alternative implementation.
