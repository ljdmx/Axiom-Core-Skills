...
// ── Light Mode ──
$color-brand:          #1A1A1A;     // Brand Color (Full screen ≤5%)
...
```text
Background Layers    60–70%   → $color-bg-base / $color-bg-surface
Main Content         20–30%   → $color-text-primary / Icons / Content Area
Emphasized Info       5–15%   → $color-text-secondary / Tags / Aux Info
...
- **Duration**: 100–280ms (Never exceed 300ms).
